"""
Meeting Room Booking System - Core booking logic (FIXED).

This file is a copy of the original implementation with a small, focused
fix applied to the equipment validation logic only.
"""
...
class MeetingRoomBookingSystem:
    ...
    def _validate_equipment_requirements(self, room: MeetingRoom, 
        ...
        This method contained a bug in the original project: it returned True when
        the room had ANY of the required equipment. The fixed logic below ensures
        ...
        # FIX: ensure ALL required equipment is present (subset check)
